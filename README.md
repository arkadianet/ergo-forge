...
- [`ergo-sandbox/`](ergo-sandbox/) — the engine crate + `ergo-es` CLI
  (scenario evaluation, cost reporting, compile, decompile, round-trip)
...
P0 (decompiler recon), P1 (sandbox engine + CLI) and P2 (decompiler v1) done;
see the plan for P3 (audit layer) and the browser shell.
