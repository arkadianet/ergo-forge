"""Read-only audit against the committed D02 prefix; no baseline rewriting."""
import hashlib
import json
...
allowed = {'docs/ROADMAP.md', 'docs/roadmap-stops.json', 'ergo-sandbox/tests/mapping_inventory.rs', 'ergo-sandbox/src/properties/mod.rs'}
