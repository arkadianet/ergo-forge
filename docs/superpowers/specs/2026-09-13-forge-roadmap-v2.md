...
```json
{
  ...
  "newUnits": [
    ...
    {"id": "I01", "implemented": true, "depends": ["W00"], "days": 2, "package": "ergo-sandbox", "target": "verify_deployment", "tests": ["verify_exact_template_and_mismatch_are_distinct", "verify_lists_differing_constants"]},
    {"id": "I02", "implemented": true, "depends": ["I01"], "days": 3, "package": "ergo-sandbox", "target": "lockfile", "tests": ["lockfile_detects_source_param_and_engine_drift", "lockfile_matches_live_box_bytes"]},
