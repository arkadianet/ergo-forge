...
```json
{
  ...
  "newUnits": [
    ...
    {"id": "S01", "implemented": true, "depends": ["S00", "S02"], "days": 3, "package": "ergo-web", "target": "checklist", "tests": ["checklist_defaults_to_unchecked", "checklist_answer_carries_provenance", "checklist_never_emits_a_score"]},
    {"id": "W06", "implemented": true, "depends": ["S01"], "days": 2, "package": "ergo-web", "target": "negative_space", "tests": ["negative_space_lines_have_anchors", "negative_space_is_labelled_static"]},
